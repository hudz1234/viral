				...
				<div style="max-width: 600px;margin: auto;">
					...
					<?php if(mysqli_num_rows($result) > 0):?>
						...
						<?php while ($row = mysqli_fetch_assoc($result)):?>
							...
							?>
							<div style="background-color:white;display: flex;border:solid thin #aaa;border-radius: 10px;margin-bottom: 10px;margin-top: 10px; width:600px; height:250px;">
								...
								<div style="flex:8">
									<?php if(file_exists($row['image'])):?>
										<div style="">
											<img src="<?=$row['image']?>" style=" display:flex; width:150px;height:150px;object-fit: cover;">
										</div>
									<?php endif;?>
									<div>
